...
do
  for i in 1 2 3 4 5
  do
      python stable_product.py --csv-path "results/1500/stable_product_p2_$i.csv" --n-examples-train 1500 --p 2 --seed $i --imbalance $j
      python stable_product.py --csv-path "results/1500/stable_product_p6_$i.csv" --n-examples-train 1500 --p 6 --seed $i --imbalance $j
  #    python prod_rl.py --csv-path "results/1500/prod_rl_$i.csv" --n-examples-train 1500 --seed $i
      python log_ltn.py --csv-path "results/1500/logltn_default_$i.csv" --n-examples-train 1500 --seed $i --imbalance $j
      python log_ltn.py --csv-path "results/1500/logltn_default_$i.csv" --n-examples-train 1500 --seed $i --use_focal --imbalance $j
